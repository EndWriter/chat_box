              ...
              <div className="card" style={{ borderRadius: "10px" }}>
                <div className="card-header px-4 py-5">
                  <h5 className="text-muted mb-0">
                    Thanks for your Order, <span style={{ color: "#000000ff" }}>User</span>!
                  </h5>
                </div>
                ...
                <div className="card-body p-4">
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    <p className="lead fw-normal mb-0" style={{ color: "#000000ff" }}>Receipt</p>
                        ...
                        <div className="col-md-10">
                          <div className="progress" style={{ height: "6px", borderRadius: "16px" }}>
                            <div
                              ...
                              role="progressbar"
                              style={{ width: "65%", borderRadius: "16px", backgroundColor: "#000000ff" }}
                              aria-valuenow="65"
                              aria-valuemin="0"
                              aria-valuemax="100"
                            />
                        ...
                        <div className="col-md-10">
                          <div className="progress" style={{ height: "6px", borderRadius: "16px" }}>
                            <div
                              className="progress-bar"
                              role="progressbar"
                              style={{ width: "20%", borderRadius: "16px", backgroundColor: "#000000ff" }}
                              aria-valuenow="20"
                              aria-valuemin="0"
                              aria-valuemax="100"
                            />
